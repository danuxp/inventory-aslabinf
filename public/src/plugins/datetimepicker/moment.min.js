!(function (e, a) {
    ...
    function e(r, d) {
        ...
        return I(function () {
            if (
                (null != M.deprecationHandler && M.deprecationHandler(null, r),
                i)
            ) {
                for (
        ...
        return e.isValid()
            ? ((a = le(a, e.localeData())),
              (oe[a] =
                  ...
                  (function (s) {
                      for (
                          var e, n = s.match(ie), a = 0, r = n.length;
                          a < r;
                          a++
                      )
                          me[n[a]]
    ...
    function ze(e, a) {
        ...
        var t = ((a % (t = 12)) + t) % t;
        return (
            (e += (a - t) / 12), 1 == t ? (Le(e) ? 29 : 28) : 31 - ((t % 7) % 2)
        );
    }
    (T =
    ...
    function Ja(e) {
        ...
        (this._isValid = (function (e) {
            ...
            for (a in e)
                if (
                    l(e, a) &&
                    (-1 === T.call(Na, a) || (null != e[a] && isNaN(e[a])))
                )
                    return !1;
            for (t = 0; t < n; ++t)
                if (e[Na[t]]) {
    ...
    (n.add = Ne),
        ...
        (n.diff = function (e, a, t) {
            ...
            switch (
                ((n = 6e4 * (s.utcOffset() - this.utcOffset())), (a = i(a)))
            ) {
                case "year":
                    r = nt(this, s) / 12;
                    break;
        ...
        (n.format = function (e) {
            return (
                (e =
                    e || (this.isUtc() ? M.defaultFormatUtc : M.defaultFormat)),
                (e = ue(this, e)),
        ...
        Jt =
            ...
            (x.as = function (e) {
                ...
                if ("month" === (e = i(e)) || "quarter" === e || "year" === e)
                    ...
                    switch (
                        ((a = this._days + Math.round(wt(this._months))), e)
                    ) {
                        case "week":
                            return a / 7 + s / 6048e5;
                        case "day":
    ...
    M.defineLocale("az", {
        ...
        ordinal: function (e) {
            ...
            var a = e % 10;
            return (
                e + (Kt[a] || Kt[(e % 100) - a] || Kt[100 <= e ? 100 : null])
            );
        },
        week: { dow: 1, doy: 7 },
    }),
    ...
    var As = {
        ...
        Es =
            (M.defineLocale("kk", {
                ...
                ordinal: function (e) {
                    return (
                        e + (As[e] || As[e % 10] || As[100 <= e ? 100 : null])
                    );
                },
                week: { dow: 1, doy: 7 },
            }),
    ...
    M.defineLocale("ky", {
        ...
        M.defineLocale("lb", {
            ...
            relativeTime: {
                future: function (e) {
                    return Us(e.substr(0, e.indexOf(" ")))
                        ? "a " + e
                        : "an " + e;
                },
                past: function (e) {
    ...
    var W = {
        ...
        Hn =
            (M.defineLocale("tg", {
                ...
                ordinal: function (e) {
                    return (
                        e + (Sn[e] || Sn[e % 10] || Sn[100 <= e ? 100 : null])
                    );
                },
                week: { dow: 1, doy: 7 },
            }),
