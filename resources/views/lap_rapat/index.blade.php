                ...
                <tbody>
                    @foreach ($data as $row)
                        <tr>
                            ...
                            <td>{{ $row->author }}</td>
                            <td><a href="{{ url('lap-rapat-cetak/' . Crypt::encryptString($row->id)) }}"
                                    class="btn btn-sm btn-warning" data-toggle="toggle" title="Lihat"
                                    data-placement="bottom" target="blank"><i class="icon-copy fa fa-file-pdf-o"></i></a>
                            </td>
                            <td>
...
@section('script')
    <script>
        ...
        function tempat(jenis_rapat) {
            ...
            if (jenis_rapat == "RB") {
                tempat +=
                    '<label>Tempat</label> <input type="text" name="tempat" class="form-control" placeholder="Rumah" id="tempat">';
            }
            $('.tempat').html(tempat);
        }
    </script>
